...
@export var about_window_packed: PackedScene
...
func _ready() -> void:
	...
	SignalBus.request_song_array_to_playlist.connect(_ivk_to_playlist_window)
...
func _ivk_about_window() -> void:
	...
	var win = about_window_packed.instantiate() as HybridWindow
	if !win: return
